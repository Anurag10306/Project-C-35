class Form{
    constructor(){
        ...
        this.question1.style('color', 'rgb(255,255,255)');
        ...
        this.question2.style('color', 'rgb(255,255,255)');
        ...
        this.question3.style('color', 'rgb(255,255,255)');
        ...
        this.question4.style('color', 'rgb(255,255,255)');
